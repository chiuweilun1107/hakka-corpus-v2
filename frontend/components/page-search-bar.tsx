          ...
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            <div className="flex-1 flex items-center bg-white rounded-xl px-4 shadow-md ring-1 ring-black/5">
              ...
              <div className="flex items-center gap-0.5 border-l border-gray-200 pl-2 ml-1">
                <button type="button" className="p-1.5 text-gray-400 hover:text-hakka-light-brown transition-colors rounded-lg hover:bg-gray-50" title="語音輸入">
                  <Mic className="h-4 w-4" />
                </button>
                <button type="button" className="p-1.5 text-gray-400 hover:text-hakka-light-brown transition-colors rounded-lg hover:bg-gray-50" title="拍照辨識">
                  <Camera className="h-4 w-4" />
                </button>
                <button type="button" className="p-1.5 text-gray-400 hover:text-hakka-light-brown transition-colors rounded-lg hover:bg-gray-50" title="OCR 文字辨識">
